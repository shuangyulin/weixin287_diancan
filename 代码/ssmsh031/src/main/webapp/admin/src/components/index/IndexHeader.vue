	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#fff","headFontSize":"28px","headUserInfoFontColor":"rgba(0, 0, 0, 1)","headBoxShadow":"0 0px 0px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(0, 0, 0, 0)","headFontColor":"rgba(0, 0, 0, 1)","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"linear-gradient(90deg, #FDCB78 0%, #FED5C7 100%)","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(0, 0, 0, 1)","headUserInfoFontSize":"18px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"18px"},
			};
		},
		created() {
			this.setHeaderStyle()
