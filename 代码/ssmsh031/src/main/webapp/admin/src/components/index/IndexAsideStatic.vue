...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: transparent url("http://codegen.caihongy.cn/20220121/831db82d8c6a439590e59945384797b2.png") no-repeat top !important;
		...
		&>.el-menu-item {
			...
			margin: 0 0 20px;
			color: rgba(253, 203, 122, 1);
			font-size: 14px;
			border-radius: 0 90px 0 0;
			border-width: 2px;
			border-style: solid;
			border-color: rgba(249, 116, 59, 1) !important;
		...
		& /deep/ .el-submenu__title {
			...
			.el-submenu__icon-arrow {
				...
				width: 12px;
				line-height: 12px;
				color: rgba(253, 203, 122, 1) !important;
				font-size: 12px;
				border-radius: 0;
				border-width: 0;
				border-style: solid;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    border-style: dashed;
                    border-color: rgba(253, 203, 122, 1);
